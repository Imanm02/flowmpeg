...
flowmpeg frames demo-media/sample.mp4 --interval 0.5 --max-frames 4 -o demo-media/sample-frames
...
| Ranked border crop suggestions | `letterboxed.mp4` | Terminal text or JSON |
