...
|---|---:|---|
| Canonical terminal commands | 80 | `COMMAND_CATALOG` |
| Command aliases | 92 | `COMMAND_CATALOG` |
...
| Documented command lines | 377 | Markdown code lines |
| Completed roadmap items | 106 | `ROADMAP.md` |
| Open roadmap items | 6 | `ROADMAP.md` |
