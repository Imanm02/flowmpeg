...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["transcode-av1", "in.mov", "-o", "out.webm"],
        ["trim", "in.mp4", "--start", "2", "--duration", "5", "-o", "out.mp4"],
        ["loop-video", "in.mp4", "--duration", "30", "-o", "out.mp4"],
        ...
        ["join-normalized", "one.mp4", "two.mp4", "-o", "out.mp4"],
        ...
        ["trim-audio", "in.wav", "--duration", "5", "-o", "out.wav"],
        ["mono-audio", "in.wav", "-o", "out.wav"],
        ["resample-audio", "in.wav", "--sample-rate", "48000", "-o", "out.wav"],
        ["volume-audio", "in.wav", "--gain-db", "4", "-o", "out.wav"],
        ["fade-audio", "in.wav", "--duration", "30", "-o", "out.wav"],
        ["delay-audio", "in.wav", "--seconds", "0.5", "-o", "out.wav"],
        ["speed-audio", "in.wav", "--factor", "1.5", "-o", "out.wav"],
        ["crossfade-audio", "one.wav", "two.wav", "-o", "out.wav"],
        ["join-audio", "one.wav", "two.wav", "-o", "out.wav"],
        ...
        ["remux", "in.mp4", "-o", "out.mkv"],
        ["tag-media", "in.mp4", "--title", "Camera master", "-o", "out.mp4"],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["av1", "in.mov", "-o", "out.webm"],
        ["cut", "in.mp4", "--duration", "2", "-o", "out.mp4"],
        ["loop", "in.mp4", "--duration", "30", "-o", "out.mp4"],
        ...
        ["cut-audio", "in.wav", "--end", "5", "-o", "out.wav"],
        ["audio-standard", "in.wav", "--layout", "mono", "-o", "out.wav"],
        ["gain", "in.wav", "--gain-db", "-3", "-o", "out.wav"],
        ["audio-fade", "in.wav", "--duration", "30", "-o", "out.wav"],
        ["sync-audio", "in.wav", "--seconds", "0.5", "-o", "out.wav"],
        ["tempo", "in.wav", "--factor", "1.5", "-o", "out.wav"],
        ["crossfade", "one.wav", "two.wav", "-o", "out.wav"],
        ["audio-join", "one.wav", "two.wav", "-o", "out.wav"],
        ["captions", "in.mp4", "captions.srt", "-o", "out.mp4"],
        ["burn-captions", "in.mp4", "captions.srt", "-o", "out.mp4"],
        ["join-any", "one.mp4", "two.mp4", "-o", "out.mp4"],
        ["timelapse", "frame-%04d.png", "-o", "out.mp4"],
        ["audiogram", "in.wav", "cover.jpg", "-o", "out.mp4"],
        ["clean-metadata", "in.mkv", "-o", "out.mkv"],
        ["rewrap", "in.mp4", "-o", "out.mkv"],
        ["label-media", "in.mp4", "--title", "Camera master", "-o", "out.mp4"],
...
def test_boomerang_doubles_progress_duration(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    received: dict[str, object] = {}
    ...
    assert cli.main(["bounce", "in.mp4", "--duration", "2.5", "-o", "out.mp4"]) == 0
    assert received["expected_duration"] == 5.0
